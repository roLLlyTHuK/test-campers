import{s as p,u as m,a as u,r as x,g as v,j as e,b as y,W as j}from"./index-e46775cf.js";import{F as z,A as N,T as C,K as q,C as F,t as L}from"./CampersGallery-9ae214cd.js";import{P as S}from"./PagesStyles.styled-0a183e34.js";const T="/test-campers/assets/tv-a3af1c79.svg",I="/test-campers/assets/shower-fec19de3.svg",M="/test-campers/assets/van-0b91f168.svg",V="/test-campers/assets/alcove-8cb8fc9f.svg",A="/test-campers/assets/fully-integrated-7c534a1c.svg",P=p.div`
  width: 360px;
  display: flex;
...
`,K=p(z)`
  ...
  left: 18px;
  cursor: pointer;
`,B=t=>{var o;return(o=t.campers)==null?void 0:o.campers},G=t=>t.campers.isFirstLoading,R=t=>t.campers.isFiltersLoading,U=t=>t.campers.isMoreLoading,X=t=>t.campers.filteredCampers,_=({onFiltersChange:t})=>{const o=m(B),s=u(),[a,i]=x.useState({location:"",equipment:[],type:""});x.useEffect(()=>{(()=>{const c=o.filter(l=>{const h=l.location.toLowerCase().includes(a.location.toLowerCase()),g=a.equipment.every(f=>l.details[f]||l[f]),k=a.type===""||l.form===a.type;return h&&g&&k});s(y(c)),t(a)})()},[a,o,s,t]);const d=n=>{const{name:c,value:l}=n.target;i({...a,[c]:l})},r=n=>{const{name:c,checked:l}=n.target;i(l?{...a,equipment:[...a.equipment,c]}:{...a,equipment:a.equipment.filter(h=>h!==c)})},b=n=>{n.preventDefault(),i({location:"",equipment:[],type:""})};return x.useEffect(()=>{s(v())},[s]),e.jsx("form",{children:e.jsxs(P,{children:[e.jsxs("div",{className:"location-filter",children:[e.jsx("p",{children:"Location"}),e.jsxs("div",{children:[e.jsx(K,{}),e.jsx("input",{type:"text",name:"location",placeholder:"Kyiv, Ukraine",className:"search-input",value:a.location,onChange:d})]})]}),e.jsxs("div",{className:"equipment-filter",children:[e.jsx("p",{children:"Filters"}),e.jsx("h3",{children:"Vehicle equipment"}),e.jsxs(E,{children:[e.jsxs("li",{children:[e.jsx("input",{type:"checkbox",name:"airConditioner",id:"airConditioner",value:"airConditioner",checked:a.equipment.includes("airConditioner"),onChange:r}),e.jsxs("label",{htmlFor:"airConditioner",children:[e.jsx("img",{src:N,alt:"air conditioner"}),e.jsx("p",{children:"AC"})]})]}),e.jsxs("li",{children:[e.jsx("input",{type:"checkbox",name:"transmission",id:"transmission",value:"transmission",checked:a.equipment.includes("transmission"),onChange:r}),e.jsxs("label",{htmlFor:"transmission",children:[e.jsx("img",{src:C,alt:"transmission"}),e.jsx("p",{children:"Automatic"})]})]}),e.jsxs("li",{children:[e.jsx("input",{type:"checkbox",name:"kitchen",id:"kitchen",value:"kitchen",checked:a.equipment.includes("kitchen"),onChange:r}),e.jsxs("label",{htmlFor:"kitchen",children:[e.jsx("img",{src:q,alt:"kitchen"}),e.jsx("p",{children:"Kitchen"})]})]}),e.jsxs("li",{children:[e.jsx("input",{type:"checkbox",name:"TV",id:"TV",value:"TV",checked:a.equipment.includes("TV"),onChange:r}),e.jsxs("label",{htmlFor:"TV",children:[e.jsx("img",{src:T,alt:"telvision"}),e.jsx("p",{children:"TV"})]})]}),e.jsxs("li",{children:[e.jsx("input",{type:"checkbox",name:"shower",id:"shower",value:"shower",checked:a.equipment.includes("shower"),onChange:r}),e.jsxs("label",{htmlFor:"shower",children:[e.jsx("img",{src:I,alt:"shower"}),e.jsx("p",{children:"Shower/WC"})]})]})]})]}),e.jsxs("div",{className:"type-filter",children:[e.jsx("h3",{children:"Vehicle type"}),e.jsxs(W,{children:[e.jsxs("div",{children:[e.jsx("input",{type:"radio",name:"type",id:"panelTruck",value:"panelTruck",checked:a.type==="panelTruck",onChange:d}),e.jsxs("label",{htmlFor:"panelTruck",children:[e.jsx("img",{src:M,alt:"panel truck"}),e.jsx("p",{children:"Van"})]})]}),e.jsxs("div",{children:[e.jsx("input",{type:"radio",name:"type",id:"fullyIntegrated",value:"fullyIntegrated",checked:a.type==="fullyIntegrated",onChange:d}),e.jsxs("label",{htmlFor:"fullyIntegrated",children:[e.jsx("img",{src:A,alt:"fully integrated"}),e.jsx("p",{children:"Fully integrated"})]})]}),e.jsxs("div",{children:[e.jsx("input",{type:"radio",name:"type",id:"alcove",value:"alcove",checked:a.type==="alcove",onChange:d}),e.jsxs("label",{htmlFor:"alcove",children:[e.jsx("img",{src:V,alt:"alcove"}),e.jsx("p",{children:"Alcove"})]})]})]})]}),e.jsx(D,{type:"submit",onClick:b,children:"Clear filters"})]})})},H=p.button`
  width: 145px;
  height: 56px;
  border-radius: 200px;
